...
export type LinkResponse<Texpand = unknown> = Required<LinkRecord> &
	BaseSystemFields<Texpand>;
export type LinkTagResponse<Texpand = unknown> =
	Required<LinkTagRecord> & BaseSystemFields<Texpand>;
